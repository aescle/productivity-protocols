...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .owner-mark span { color: var(--muted); font-weight: 400; letter-spacing: 0; }
  .owner-cta { color: var(--muted); text-decoration: none; }
  .owner-cta:hover, .owner-mark:hover span { color: var(--ink); }
  ...
  .foot-cta { flex: 0 0 auto; text-decoration: none; font-weight: 600; }

  /* ── responsive ───────────────────────────────────────────── */
  @media (max-width: 900px) {
    .wrap { padding: 0 20px; }
    .owner-in { min-height: 48px; }
    .owner-mark span { display: none; }
    ...
    .foot-cta { display: inline-block; margin-top: 16px; }
  }
...
<nav class="owner" aria-label="Aescle">
  <div class="wrap owner-in">
    <a class="owner-mark" href="https://aescle.com" aria-label="Aescle home">
      ...
      <b>AESCLE</b><span>Open protocol bank</span>
    </a>
    <a class="owner-cta" href="https://aescle.com/?beta=1">See how Aescle personalizes this →</a>
  </div>
</nav>
<div class="wrap">
  <header class="mast">
...
<div class="wrap">
  <footer>
    ...
    <div class="foot-brand">
      <div><strong>Built and maintained by Aescle.</strong><span>Aescle connects protocols to your own health and work patterns, then helps you act at the right time.</span></div>
      <a class="foot-cta" href="https://aescle.com/?beta=1">Explore Aescle →</a>
    </div>
  </footer>
</div>
